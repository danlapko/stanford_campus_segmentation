 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "Semi-supervised (https://paperswithcode.com/task/semi-supervised-semantic-segmentation) and Weakly supervised (https://paperswithcode.com/task/weakly-supervised-semantic-segmentation, https://www.youtube.com/watch?v=jM1T1HwbY5s&ab_channel=RodrigoBenenson).\n",
